...
// Escape HTML TRƯỚC rồi mới áp dụng định dạng -> nội dung không thể chèn
// thẻ HTML/script (chống XSS). Chỉ hỗ trợ tập con phổ biến: in đậm, in
// nghiêng, gạch đầu dòng và xuống dòng.
