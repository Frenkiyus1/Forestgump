...
const LANG_KEY = 'forestgump_lang';
...
const dict: Record<Lang, Record<string, string>> = {
	vi: {
		...
		'onboarding.subtitle': 'Giúp ForestGump cá nhân hoá cảnh báo cho khu vực canh tác của bạn.',
	...
	en: {
		...
		'onboarding.subtitle': 'Help ForestGump personalise alerts for your farm.',
...
<svelte:head><title>{t('login.title')} — ForestGump</title></svelte:head>
	...
	<section class="flex items-center justify-center bg-cream px-6 py-16">
		<div class="w-full max-w-sm">
			<div class="mb-8 flex items-center gap-3 lg:hidden">
				...
				<span class="text-xl font-semibold text-gray-900">ForestGump</span>
			</div>
...
<svelte:head><title>{t('onboarding.title')} — ForestGump</title></svelte:head>
